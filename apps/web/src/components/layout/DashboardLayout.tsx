...
const navigation = [
  ...
  { name: 'Consultas', href: '/appointments', icon: CalendarIcon, current: false },
  { name: 'Relatórios', href: '/reports', icon: ChartBarIcon, current: false },
  { name: 'Documentos', href: '/documents', icon: FolderIcon, current: false },
]
          ...
          <div className="sticky top-0 z-40 flex h-16 shrink-0 items-center gap-x-4 border-b border-border bg-surface px-4 shadow-sm sm:gap-x-6 sm:px-6 lg:px-8">
            ...
            <div className="flex flex-1 gap-x-4 self-stretch lg:gap-x-6">
              <form className="relative flex flex-1" action="#" method="GET">
                ...
                <input
                  id="search-field"
                  className="block h-full w-full border-0 py-0 pl-8 pr-0 text-text-primary placeholder:text-text-tertiary focus:ring-0 sm:text-sm"
                ...
                <Menu as="div" className="relative">
                  <Menu.Button className="-m-1.5 flex items-center p-1.5">
                    ...
                    <span className="hidden lg:flex lg:items-center">
                      <span
                        className="ml-4 text-sm font-semibold leading-6 text-text-primary"
                        aria-hidden="true"
                      >
                        Dr. João Silva
                      </span>
                  ...
                  >
                    <Menu.Items className="absolute right-0 z-10 mt-2.5 w-32 origin-top-right rounded-md bg-surface py-2 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                          ...
                          {({ active }) => (
                            <a
                              ...
                              className={classNames(
                                ...
                                'block px-3 py-1 text-sm leading-6 text-text-primary'
                              )}
                            >
                              {item.name}
                            </a>
